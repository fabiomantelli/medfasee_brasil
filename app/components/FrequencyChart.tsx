...
export default function FrequencyChart({ pmuMeasurements }: FrequencyChartProps) {
  ...
  return (
    <div className="h-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-2 sm:p-4 flex flex-col">
      ...
      <div className="flex-1 relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-xl p-2 sm:p-4 border border-slate-300 dark:border-slate-600 shadow-inner overflow-x-auto flex items-center justify-center">
        <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-full drop-shadow-sm" style={{maxHeight: '100%', maxWidth: '100%'}}>
      ...
      {/* Date display and Legend - moved outside and made compact */}
      <div className="flex-shrink-0 mt-2">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-1">
              <div className="w-3 h-0.5 bg-emerald-500 border-t border-dashed border-emerald-500"></div>
              <span className="text-gray-700 dark:text-gray-300">60Hz</span>
            </div>
            <div className="flex items-center space-x-1">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <span className="text-gray-700 dark:text-gray-300">Atual</span>
            </div>
            <div className="flex items-center space-x-1">
              <div className="w-3 h-0.5 bg-amber-500 opacity-60 border-t border-dashed border-amber-500"></div>
              <span className="text-gray-700 dark:text-gray-300">±0.1Hz</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 text-gray-500 dark:text-gray-400">
            ...
            <span>Atualização: {new Date().toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}</span>
          </div>
        </div>
      </div>
    </div>
